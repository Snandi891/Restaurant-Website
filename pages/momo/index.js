...
const dishes = [
  {
    ...
    title: "Veg Momo",
    description:
      " Steamed dumplings packed with fresh vegetables and herbs, offering a light, healthy, and flavorful bite.",
    price: 30,
  },
  {
    image: "/momo3.jpg",
    title: "Fried Momo",
    description:
      " Crispy golden dumplings deep-fried to perfection, with a crunchy shell and a juicy, flavorful filling inside",
    price: 110,
  },
  {
    image: "/momo2.jpg",
    title: "Chicken Momo",
    description:
      " Soft steamed dumplings stuffed with spiced minced chicken, bursting with savory and aromatic flavors.",
    price: 80,
  },
];
